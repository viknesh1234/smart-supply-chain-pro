...
const PurchaseOrders: React.FC = () => {
  ...
  const purchaseOrders: PurchaseOrder[] = Array.isArray(ordersData) ? ordersData : [];
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">
                ${purchaseOrders.reduce((sum, o) => sum + (o.totalAmount || 0), 0).toLocaleString()}
              </p>
            </div>
          </div>
        </CardContent></Card>
        ...
        <Card><CardContent className="p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-600">{statsData?.pendingOrders ?? 0}</p>
            </div>
          </div>
        </CardContent></Card>
        ...
        <Card><CardContent className="p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{statsData?.inTransitOrders ?? 0}</p>
            </div>
          </div>
        </CardContent></Card>
      </div>
